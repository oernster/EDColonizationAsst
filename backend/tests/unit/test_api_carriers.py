...
@pytest.mark.asyncio
async def test_carriers_current_and_state_with_fleet_carrier(tmp_path: Path, monkeypatch: Callable):
  ...
  events = [
      ...
      },
      {
          ...
          "Crew": [
              { "CrewRole": "Captain", "Activated": True, "Enabled": True, "CrewName": "Swara Phillips" },
              { "CrewRole": "Exploration", "Activated": True, "Enabled": True, "CrewName": "Roland Lechner" },
              { "CrewRole": "Outfitting", "Activated": True, "Enabled": True, "CrewName": "Alvaro Stokes" },
          ],
      },
      {
...
@pytest.mark.asyncio
async def test_carriers_mine_lists_own_and_squadron(tmp_path: Path, monkeypatch: Callable):
