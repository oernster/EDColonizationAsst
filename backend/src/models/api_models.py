...
class SystemResponse(BaseModel):
    ...
    construction_sites: List[ConstructionSite] = Field(description="Construction sites in system")
...
class CommodityAggregateResponse(BaseModel):
    ...
    commodities: List[CommodityAggregate] = Field(description="Aggregated commodity data")
...
class HealthResponse(BaseModel):
    ...
    journal_accessible: bool = Field(description="Whether journal directory is accessible")
...
class WebSocketMessage(BaseModel):
    ...
    system_name: Optional[str] = Field(None, description="System name for subscribe/update")
